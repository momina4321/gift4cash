...
export default function Faq(){
    ...
    <div className="flex flex-col gap-7 justify-between items-center  " >
      <div className="flex gap-5 text-base font-semibold lg:flex sm:hidden">  
        ...
        <div className="flex flex-col rounded-xl border-2 px-10 py-4 lg:w-[1280px]  sm:w-[900px]" >
             <div className="flex justify-between" >
                   <p className="text-green font-semibold" >What is Gift4Cash?</p>
                   <Image src="/vector.svg"  width={16} height={8} alt="vector" />
             </div>
             <div className="flex flex-col gap-5 text-gray-500 font-medium pt-4 lg:flex sm:hidden">
